...
![异步导入的结果](../../assets/images/webpack/32.png)
<br/><br/>

当我们点击页面时，才 **真正开始加载** 第三方模块，如下图(`1.js`)：

![异步导入的结果](../../assets/images/webpack/33.png)
...
![Prefetch结果](../../assets/images/webpack/19.png)
...
![打包结果](../../assets/images/webpack/20.png)
...
![打包结果](../../assets/images/webpack/21.png)
...
![打包结果](../../assets/images/webpack/22.png)
